...
class EducationFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lateinit var eduList : MutableList<Education>
        eduList = ArrayList()
        eduList = AppDataBase.getDatabase(view.context).eduDao().getAllEdu() as MutableList<Education>
        EducationRecycler = view.findViewById(R.id.EducationRecycler)!!

        EducationAdapter = educationAdapter(eduList)
